...
type GotErrorProp = {gotError: boolean};
...
const FillGroceriesButton = ({
  ...
  const contentViews = {
    ...
    after: <PanelAfterGenerating gotError={false} />,
    error: <PanelAfterGenerating gotError={true} />,
  };
...
const PanelAfterGenerating = ({gotError}: GotErrorProp) => {
